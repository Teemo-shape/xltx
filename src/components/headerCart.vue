<template>
    <header class="clearfix">
        ...
        <!-- 购物车  指不定啥时候加上 -->
        <!-- <a class="shop_car_logo f_r" href="/goods/view_cart.html">
            <i class="iconfont">&#xe603;</i>
            <span>3</span>
        </a> -->
        <div class="search f_l">
            ...
            <div class="search_container">
                <input type="text" @keyup.enter="search" v-model="keyword" class="search_input" value="" name="select" :placeholder="placeholder" />
            </div>
		...
		<div class="account_list pop_header f_r" v-if="has_login">
			<div class="button butn clearfix"><span @click="account_show=!account_show;" class="iconfont select_show f_r">&#xe792;</span><a href="/company/member_index.html" :title="user_name" class="user_name ellipsis f_r">{{user_name}}</a></div>
				<ul class="account_items arrow_appear" v-show="account_show">
						<a href="/company/member_index.html" class="myhome button">我的主页</a>
...
import "../../static/js/libs/get-user.js";
    ...
    setTimeout(() => {
      var data = {
        list: [
          ...
          {
            name: "模拟器件",
            child: [{ name: "放大器" }, { name: "稳压器" }, { name: "传感器" }]
          },
          {
            name: "分立器件",
            child: [{ name: "二极管" }, { name: "晶体管" }]
          },
          {
            name: "机电产品",
            child: [
