...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        defineDems: function () {
            var stop = false;
            // TODO [PROVINCE, CITY, DISTRICT]表示省市区，有几项则几级联动，该项目只需要两级联动，可调
...
//              if ($active.data('code') !== $(this).data('code')) {
                    ...
                    if (last) {
                        $this.close();
                        $(".city-picker-span").css("border","solid 1px #d1d1d1");
                    }
//              }
				e.stopPropagation();
        ...
        feedText: function (flag) {
            var text = this.getText(flag);
            if (text) {
                this.$textspan.find('>.placeholder').hide();
                this.$textspan.find('>.title').html(this.getText(flag)).show();
            } else {
